...
import { FacilityConfig, AISettings, TabId, ViewMode } from '../../../types';
...
===================================================================`;
  ...
  return (
    <div className="space-y-8 animate-fadeIn pb-16 font-sans">
      ...
      {/* ========================================================================= */}
      {/* CALCULATED RESULT / OUTPUT COMPONENT (EXCLUSIVELY SCOPED METRIC CARDS) */}
      {/* ========================================================================= */}
      <div className="pt-6 border-t border-slate-200 dark:border-slate-800 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <h3 className="text-base font-bold text-slate-900 dark:text-white">
              Facility Configuration Calculated Output
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Live recalculated baseline carbon metrics and expected ROI derived from parameters above.
            </p>
          </div>
        ...
        <KPICards kpiData={liveSimulation.kpiData} viewMode={viewMode} />
      </div>
