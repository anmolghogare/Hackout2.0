...
import { Download, FileCheck, CheckCircle2, ShieldCheck, X, Sparkles } from 'lucide-react';
...
export const BRSRExportModal: React.FC<BRSRExportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      <div className="w-full max-w-4xl rounded-3xl bg-white dark:bg-[#141724] border border-slate-200/80 dark:border-white/[0.08] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              <h3 className="font-extrabold font-heading text-lg text-slate-900 dark:text-white flex items-center space-x-2">
                ...
                <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 font-mono font-bold border border-emerald-500/25">
                  ISO 14064 Verified
                </span>
              </h3>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-slate-800 dark:text-slate-200">
          ...
          <div className="p-5 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200/80 dark:border-white/[0.08] space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono pt-3 border-t border-slate-200 dark:border-slate-700/60">
              ...
              <div>
                ...
                <span className="font-bold text-emerald-600 dark:text-emerald-400">{formatNumber(100 - kpiData.monthlyCO2SavedTons)} tCO₂e/mo</span>
              </div>
              <div>
                <span className="text-slate-400 block text-[10px]">VERIFIED CUT %</span>
                <span className="font-bold text-emerald-600 dark:text-emerald-400">-{kpiData.co2ReductionPercentage}%</span>
              </div>
              <div>
                <span className="text-slate-400 block text-[10px]">ANNUAL NET ROI</span>
                <span className="font-bold text-slate-900 dark:text-white">{kpiData.financialSavings.totalNetSavingsDisplay}</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="overflow-x-auto border border-slate-200/80 dark:border-white/[0.08] rounded-2xl">
              <table className="w-full text-left text-xs border-collapse font-mono">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-slate-800 text-slate-500 uppercase tracking-wider bg-slate-100 dark:bg-white/[0.03]">
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                  ...
                  <tr>
                    <td className="p-3 font-bold text-emerald-600 dark:text-emerald-400">Scope 2 (Indirect)</td>
                  ...
                  <tr>
                    <td className="p-3 font-bold text-slate-700 dark:text-slate-300">Scope 3 (Upstream)</td>
