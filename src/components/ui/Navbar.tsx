    ...
    <header className="sticky top-0 z-30 w-full h-16 border-b border-slate-200 dark:border-slate-800/80 bg-white/90 dark:bg-[#070d19]/90 backdrop-blur-xl transition-colors duration-300 px-4 sm:px-8 flex items-center justify-between shadow-sm">
      ...
      <div className="flex items-center space-x-2.5 sm:space-x-3">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 hover:border-emerald-500/50 transition-all shadow-xs"
          ...
          {activeGoogleUser ? (
            <>
              <img
                ...
                className="w-6 h-6 rounded-full border border-emerald-500 bg-white shrink-0"
              />
              <span className="text-xs font-semibold text-slate-800 dark:text-slate-200 hidden md:inline truncate max-w-[110px]">
