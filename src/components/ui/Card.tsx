...
export const Card: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  <div
    className={cn(
      'rounded-2xl border border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-xl dark:shadow-2xl text-slate-900 dark:text-slate-100 transition-all duration-300 hover:border-slate-300 dark:hover:border-slate-700/80',
      className
    )}
    {...props}
  >
